...
cmake .. -DBOOST_ROOT=/home/kegcoin-gold/boost_1_59_0
make -j4
```

**If self compiled, please provide of your kegcoin CMake output at the default verbosity**:
```
...
**Binary Reported:** <!-- does this issue affect kegwallet, kegcoind, kegcoin-service, kegminer? -->
