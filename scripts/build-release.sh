...
function usage()
{
    ...
    echo "and generates the checksum files of the kegcoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/kegcoin-project/kegcoin-gold.git"
CLONE_DIR="$BUILD_DIRECTORY/kegcoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/kegcoin-releases"
DYNAMIC_RELEASE="kegcoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="kegcoin-${TAG_VERSION}-linux-staticboost-CLI"
