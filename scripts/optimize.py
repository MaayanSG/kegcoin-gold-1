# USAGE: Start kegcoin-service as you usually would
...
from kegcoin import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="kegcoin address to optimize", required=True)
